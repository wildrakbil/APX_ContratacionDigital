...
public abstract class AbstractQTDIT07101ESTransaction extends AbstractTransaction {
	...
	public AbstractQTDIT07101ESTransaction(){
	}

	/**
	 * Return value for input parameter applicant
	 */
	protected DTOIntApplicant getApplicant(){
		return (DTOIntApplicant)getParameter("applicant");
	}
	 ...
	 */
	protected void setAddresses(final DTOIntAddresses field){
