...
import com.bbva.qtdi.QTDIT07901ESTransaction;


/**
 * Test for transaction QTDIT07901ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07901ESTest.xml" })
public class QTDIT07901ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07901ESTransactionTest.class);
	
	@Autowired
	private QTDIT07901ESTransaction transaction;
