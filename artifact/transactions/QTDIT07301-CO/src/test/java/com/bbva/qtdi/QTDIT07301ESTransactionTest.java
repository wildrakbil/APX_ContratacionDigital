...
import com.bbva.qtdi.QTDIT07301ESTransaction;


/**
 * Test for transaction QTDIT07301ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07301ESTest.xml" })
public class QTDIT07301ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07301ESTransactionTest.class);
	
	@Autowired
	private QTDIT07301ESTransaction transaction;
