...
import com.bbva.qtdi.QTDIT07201ESTransaction;


/**
 * Test for transaction QTDIT07201ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07201ESTest.xml" })
public class QTDIT07201ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07201ESTransactionTest.class);
	
	@Autowired
	private QTDIT07201ESTransaction transaction;
