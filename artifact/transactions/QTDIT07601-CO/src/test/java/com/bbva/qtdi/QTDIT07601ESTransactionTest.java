...
import com.bbva.qtdi.QTDIT07601ESTransaction;


/**
 * Test for transaction QTDIT07601ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07601ESTest.xml" })
public class QTDIT07601ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07601ESTransactionTest.class);
	
	@Autowired
	private QTDIT07601ESTransaction transaction;
