...
import com.bbva.qtdi.QTDIT07701ESTransaction;


/**
 * Test for transaction QTDIT07701ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07701ESTest.xml" })
public class QTDIT07701ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07701ESTransactionTest.class);
	
	@Autowired
	private QTDIT07701ESTransaction transaction;
