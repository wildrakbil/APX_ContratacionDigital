...
/**
 * Test for transaction QTDIT08101ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT08101ESTest.xml" })
public class QTDIT08101ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT08101ESTransactionTest.class);
	
	@Autowired
	private QTDIT08101ESTransaction transaction;
