...
import com.bbva.qtdi.QTDIT07401ESTransaction;


/**
 * Test for transaction QTDIT07401ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07401ESTest.xml" })
public class QTDIT07401ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07401ESTransactionTest.class);
	
	@Autowired
	private QTDIT07401ESTransaction transaction;
