...
import com.bbva.qtdi.QTDIT08001ESTransaction;


/**
 * Test for transaction QTDIT08001ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT08001ESTest.xml" })
public class QTDIT08001ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT08001ESTransactionTest.class);
	
	@Autowired
	private QTDIT08001ESTransaction transaction;
