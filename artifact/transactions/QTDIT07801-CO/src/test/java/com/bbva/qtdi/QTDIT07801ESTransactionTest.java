...
import com.bbva.qtdi.QTDIT07801ESTransaction;


/**
 * Test for transaction QTDIT07801ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07801ESTest.xml" })
public class QTDIT07801ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07801ESTransactionTest.class);
	
	@Autowired
	private QTDIT07801ESTransaction transaction;
