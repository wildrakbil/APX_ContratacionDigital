...
import com.bbva.qtdi.QTDIT07501ESTransaction;


/**
 * Test for transaction QTDIT07501ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDIT07501ESTest.xml" })
public class QTDIT07501ESTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDIT07501ESTransactionTest.class);
	
	@Autowired
	private QTDIT07501ESTransaction transaction;
