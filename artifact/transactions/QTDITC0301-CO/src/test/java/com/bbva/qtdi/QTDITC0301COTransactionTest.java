...
/**
 * Test for transaction QTDITC0301COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/QTDITC0301COTest.xml" })
public class QTDITC0301COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(QTDITC0301COTransactionTest.class);
	
	@Autowired
	private QTDITC0301COTransaction transaction;
